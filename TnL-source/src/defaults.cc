...
void initialize_config(Ptr<IConfig> config)
{
    ...
    config->set("Carrier_model_path", std::string(config->query("model_dir")) + "/carrier");
    config->set("Drone_model_path", std::string(config->query("model_dir")) + "/lightning");

    config->set("Camera_aspect", "1.333");
    config->set("Camera_focus", "1.5");
    config->set("Carrier_Vulcan_rounds", "2400");
    config->set("Carrier_model_bounds", std::string(config->query("Carrier_model_path")) + "/carrier.bounds");
    config->set("Carrier_model_hull", std::string(config->query("Carrier_model_path")) + "/carrier-hull-reduced.obj");
    config->set("Carrier_skeleton", std::string(config->query("Carrier_model_path")) + "/Carrier.spec");
    config->set("Drone_Hydra_rounds", "14");
    config->set("Drone_Sidewinder_rounds", "6");
    config->set("Drone_Vulcan_rounds", "250");
    ...
    config->set("DumbMissile_Ixx", "6");
    config->set("DumbMissile_Iyy", "6");
    config->set("DumbMissile_Izz", "2");
    config->set("DumbMissile_CdA_f", "0.00007663950621");
    config->set("DumbMissile_CdA_s", "0.086865");
    config->set("DumbMissile_blast_begin", "0");
    config->set("DumbMissile_blast_end", "1.05");
    config->set("DumbMissile_engine_sound", "rocket-engine-1.wav");
    config->set("DumbMissile_mass", "10.705");
    config->set("DumbMissile_max_lifetime", "30");
    config->set("DumbMissile_max_thrust", "7545");
    config->set("DumbMissile_min_explosion_age", "0");
    config->set("DumbMissile_model", std::string(config->query("model_dir")) + "/missiles/dumbmissile.obj");
    config->set("DumbMissile_torque_factor_xy", "3");
    config->set("DumbMissile_torque_factor_z", "3");
    config->set("DumbMissile_pitching_factor", "0.01");
    ...
    config->set("Explosion_frames", "16");
    config->set("Explosion_num_sounds", "1");
    config->set("Explosion_seconds_per_frame", "0.08");
    config->set("Explosion_size", "20.0");
    config->set("Explosion_sound_prefix", "explosion-0");
    config->set("Explosion_sound_postfix", ".wav");
    config->set("Explosion_tex_prefix", std::string(config->query("texture_dir")) + "/explosion/explosion");
    config->set("Explosion_tex_postfix", ".png");
    config->set("FontMan_default_font", "dejavu-sans-24-normal");
    config->set("FontMan_dir", config->query("fonts_dir"));
    config->set("Game_grab_mouse", "true");
    ...
    config->set("Hydra_guided", "false");
    config->set("Hydra_launch_speed", "0");
    config->set("Hydra_loadtime", "1");
    config->set("Hydra_max_range", "5000");
    config->set("Hydra_needs_target", "false");
    config->set("Hydra_reference_speed", "739.14");
    config->set("Hydra_singleshot", "true");
    config->set("Hydra_time_of_accel", "1.05");
    config->set("InfoMessages_realtime", "false");
    config->set("Lensflare_reflex_tex", std::string(config->query("texture_dir")) + "/lensreflex.png");
    config->set("Lensflare_sparkle_thick_tex", std::string(config->query("texture_dir")) + "/sparkle-thick.png");
    config->set("Lensflare_sparkle_thin_tex", std::string(config->query("texture_dir")) + "/sparkle-thin.png");
    config->set("Lensflare_rot_speed_thick", "-0.5");
    config->set("Lensflare_rot_speed_thin", "1.5");
    ...
    config->set("Observer_accel_x", "10");
    config->set("Observer_accel_y", "-10");
    config->set("Observer_accel_z", "-15");
    config->set("Observer_rotate_x", "0.2");
    config->set("Observer_rotate_y", "0.2");
    config->set("Observer_speed_factor", "0.04");
    config->set("SmokeColumn_puffy_tex", std::string(config->query("texture_dir")) + "/puffy_smoke.png");
    config->set("SmokeTrail_smoke_tex", std::string(config->query("texture_dir")) + "/missile_smoke.spr");
    config->set("SmokeTrail_puffy_tex", std::string(config->query("texture_dir")) + "/puffy_smoke.png");
    config->set("Sidewinder_guided", "false");
    config->set("Sidewinder_launch_speed", "0");
    config->set("Sidewinder_loadtime", "1");
    config->set("Sidewinder_max_range", "5000");
    config->set("Sidewinder_needs_target", "false");
    ...
    config->set("Vulcan_factor", "0.45");
    config->set("Vulcan_gain", "0.05");
    config->set("Vulcan_guided", "false");
    config->set("Vulcan_loadtime", "0.2");
    config->set("Vulcan_max_range", "5000");
    config->set("Vulcan_muzzle_velocity", "800");
    config->set("Vulcan_reference_distance", "100");
    config->set("Vulcan_reference_speed", "800");
    config->set("Vulcan_singleshot", "false");
    config->set("Vulcan_sound", "cannon-shoot-2.wav");
    config->set("Vulcan_time_of_accel", "0");
    ...
    config->set("Water_mirror_texture_size", "512");
